...
!function (a) {
    ...
    a.extend(a.validator, {
        ...
        "messages": {
            ...
            "PANCard": "Please enter a valid PAN Card #",
            "GSTN": "Please enter a valid GSTN #",
            "INMobile": "Please enter a valid Indian Mobile #",
            "IsDecimal": "Please enter a valid Decimal Value",
            "IsInt": "Please enter a valid Integer Value",
        ...
        "methods": {
            ...
            "email": function (a, b) {
                return this.optional(b) || /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/i.test(a)
            },
            "IsDecimal": function (a, b) {
                return this.optional(b) || /^(\d*\.?\d*[0-9]+\d*$)|(^[1-9]+\d*\.\d*)$/i.test(a)
            },
            "IsInt": function (a, b) {
                return this.optional(b) || /^\d+$/i.test(a)
            },
            "PANCard": function (a, b) {
                return this.optional(b) || /^[a-zA-z]{5}\d{4}[a-zA-Z]{1}$/i.test(a)
            },
            "PinCode": function (a, b) {
                return this.optional(b) || /^([0-9]{6}|[0-9]{3}\s[0-9]{3})$/i.test(a)
            },
            "GSTN": function (a, b) {
                return this.optional(b) || /^[0-9]{2}[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}[1-9A-Za-z]{1}[Z]{1}[0-9a-zA-Z]{1}$/i.test(a)
            },
            "INMobile": function (a, b) {
                return this.optional(b) || /^([7-9][0-9]{9})$/i.test(a)
            },
            "url": function (a, b) {
